...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" ><a href="seleccion12.php">Seleccion Nacional</a></li>
    <li role="presentation" class="active"><a href="sancion12.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.sancion AS s, futbol.jugador AS j where j.id_equipo=12 AND s.rut_j = j.rut_j";
...
if($numReg>0){
  echo "<table border='1' align='center'>
    ...
    <th>Descripcion</th>
    <th>Partidos Sancionados</th>
    <th>Año</th></tr>";
  while ($fila=pg_fetch_array($resultado)) {
    echo "<tr>"."<td>".$fila['nombre_j']."</td>";
    echo "<td>".$fila['apellido_j']."</td>";
    echo "<td>".$fila['tipo_sancion']."</td>";
    echo "<td>".$fila['descripcion']."</td>";
    echo "<td>".$fila['cantidad_partidos_sancionado']."</td>";
    echo "<td>".$fila['ano_s']."</td></tr>";
  }
    echo "</table>";
}
else{
