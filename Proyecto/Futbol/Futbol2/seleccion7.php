...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" ><a href="estadistica7.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion7.php">Seleccion Nacional</a></li>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =7 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
