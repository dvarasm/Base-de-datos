...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="ucatolica.php">Universidad Católica</a></li>
...
<ul class="nav nav-tabs">
    <li role="presentation" ><a href="ucatolica.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica15.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion15.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion15.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =15 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
