...
<p>&nbsp; </p>
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a href="unionespanola.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica14.php">Estadística Jugadores</a></li>
    <li role="presentation" ><a href="seleccion14.php">Sanciones</a></li>
...
$query = "select * from futbol.jugador where id_equipo=14";
