...
<p>&nbsp; </p>
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a href="audax.php">Audax Italiano</a></li>
...
<ul class="nav nav-tabs">
    <li role="presentation" ><a href="audax.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica1.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion1.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion1.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =1 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
