...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="huachipato.php">Huachipato</a></li>
...
<ul class="nav nav-tabs">
    <li role="presentation" ><a href="huachipato.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica8.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion8.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion8.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =8 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
