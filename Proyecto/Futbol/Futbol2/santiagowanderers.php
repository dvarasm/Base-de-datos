...
<p>&nbsp; </p>
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a href="santiagowanderers.php">Jugadores</a></li>
...
$query = "select * from futbol.jugador where id_equipo=12";
