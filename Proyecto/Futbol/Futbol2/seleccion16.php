...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="udechile.php">Universidad de Chile</a></li>
</ul>

<p>&nbsp; </p>

<ul class="nav nav-tabs">
    <li role="presentation" ><a href="udechile.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica16.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion16.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion16.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =16 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
