...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="estadistica8.php">Estadística Jugadores</a></li>
...
$query = "select * from futbol.estadistica_j AS e, futbol.jugador AS j where e.id_equipo=8 AND e.rut_j=j.rut_j";
