...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="sancion7.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.sancion AS s, futbol.jugador AS j where j.id_equipo=7 AND s.rut_j = j.rut_j";
