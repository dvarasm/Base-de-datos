...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" ><a href="everton.php">Everton</a></li>
    ...
    <li role="presentation" class="active"><a href="santiagowanderers.php">Santiago Wanderers</a></li>
...
<ul class="nav nav-tabs">
    <li role="presentation" ><a href="santiagowanderers.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica12.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion12.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion12.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =12 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
...
if($numReg>0){
  ...
  while ($fila=pg_fetch_array($resultado)) {
    echo "<tr>"."<td>".$fila['nombre_seleccion']."</td>";
    echo "<td>".$fila['nombre_j']."</td>";
    echo "<td>".$fila['apellido_j']."</td>";
    echo "<td>".$fila['cantidad_partidos']."</td>";
    echo "<td>".$fila['goles']."</td>";
    echo "<td>".$fila['ano_debut']."</td></tr>";
  }
    echo "</table>";
}
else{
