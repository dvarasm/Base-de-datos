...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" ><a href="seleccion6.php">Seleccion Nacional</a></li>
    <li role="presentation" class="active"><a href="sancion6.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.sancion AS s, futbol.jugador AS j where j.id_equipo=6 AND s.rut_j = j.rut_j";
