...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="antofagasta.php">Deportes Antofagasta</a></li>
...
<ul class="nav nav-tabs">
    <li role="presentation" ><a href="antofagasta.php">Jugadores</a></li>
    <li role="presentation" ><a href="estadistica4.php">Estadística Jugadores</a></li>
    <li role="presentation" class="active"><a href="seleccion4.php">Seleccion Nacional</a></li>
    <li role="presentation" ><a href="sancion4.php">Sanciones</a></li>
</ul>
...
$query = "select * from futbol.jugador AS j, futbol.juega_s AS s, futbol.seleccion_nacional AS sn where j.id_equipo =4 AND j.rut_j = s.rut_j AND s.nombre_seleccion = sn.nombre_seleccion";
